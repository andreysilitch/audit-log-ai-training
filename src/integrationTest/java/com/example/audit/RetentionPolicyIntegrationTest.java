...
class RetentionPolicyIntegrationTest {
  ...
  void archivesEventsOlderThanRetentionWindow() {
    ...
    repository.append(
        new NewAuditEvent(
            longAgo, oldActor, "a", "r", AuditOutcome.SUCCESS, objectMapper.createObjectNode()));
    repository.append(
        new NewAuditEvent(
            longAgo.plusSeconds(1),
            oldActor,
            "a",
            "r",
            AuditOutcome.DENIED,
    ...
    repository.append(
        new NewAuditEvent(
            recent, newActor, "a", "r", AuditOutcome.SUCCESS, objectMapper.createObjectNode()));
  ...
  void archivalIsIdempotent() {
    ...
    repository.append(
        new NewAuditEvent(
            longAgo, actor, "a", "r", AuditOutcome.SUCCESS, objectMapper.createObjectNode()));
