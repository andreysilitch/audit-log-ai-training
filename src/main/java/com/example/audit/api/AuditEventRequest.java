...
/**
 * Client-supplied fields only. Server-managed fields (timestamp, id, hash chain,
 * sequence_no) are never accepted from the client (AGENTS.md architectural rule 2).
 */
