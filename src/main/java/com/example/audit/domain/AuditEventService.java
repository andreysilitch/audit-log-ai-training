...
public class AuditEventService {
    ...
    public AuditEvent record(String actor,
                             String action,
                             String resource,
        ...
        JsonNode safeContext = (context == null || context.isNull())
        ...
        return repository.append(new NewAuditEvent(
                timestamp, actor, action, resource, outcome, safeContext));
    }
