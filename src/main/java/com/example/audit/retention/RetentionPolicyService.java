 ...
 *
 * Physical deletion from the main table is intentionally NOT performed here:
 * AGENTS.md invariant 5 requires that any such deletion be a separate, explicit
 * architectural decision with its own tests and audit of the immutable guarantee
...
public class RetentionPolicyService {
    ...
    public RetentionPolicyService(AuditEventRepository repository,
    ...
    public void run() {
        ...
        log.info("Retention run: archived {} of {} events older than {}",
                archived, batch.size(), cutoff);
    }
}
